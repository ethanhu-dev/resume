...
%%
%% Margins:  margin      0.5in       default    Document margins for all sides
%%                       1.0in
%%                       1.5in
%%
%% Autosize: fitpage     true                   Autosize all text to one page
%%                       false       default    May result in small text
%%
%%           framepage   true                   Set visible box around text
%%                       false       default    Requires fitpage to be on
%%
%%
%% Font:     fontsize    10pt                   Standard font sizes
%%                       11pt        default
%%                       12pt
%%
%%           fontface    cormorant   default    Font faces require LuaTeX
%%                         garamond
%%                       timesnew
%%                         roman
%%                       arial
...
%%                       roboto
%%
%% all options in [key=value] form, if value not specified [key=default]
%%

\documentclass[fontsize=11pt,fontface=cormorantgaramond,fitpage]{cvtemplate}
...
% \website{}
\email{ethu@ucsc.edu}
\linkedin{linkedin.com/in/ethu}
% \github{github.com/ethanhu99}
